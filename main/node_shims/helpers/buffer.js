...
// https://esm.sh/v135/base64-js@1.5.1/denonext/base64-js.development.mjs
...
// https://esm.sh/v135/ieee754@1.2.1/denonext/ieee754.development.mjs
...
// https://esm.sh/v135/buffer@6.0.3/denonext/buffer.development.mjs
var require2 = (n) => {
...
var require_buffer = __commonJS3({
  "../esmd/npm/buffer@6.0.3/node_modules/.pnpm/buffer@6.0.3/node_modules/buffer/index.js"(exports) {
    ...
    Buffer3.prototype.readUintLE = Buffer3.prototype.readUIntLE = function readUIntLE(offset, byteLength22, noAssert) {
      offset = offset >>> 0;
    ...
    Buffer3.prototype.readUintBE = Buffer3.prototype.readUIntBE = function readUIntBE(offset, byteLength22, noAssert) {
      offset = offset >>> 0;
      byteLength22 = byteLength22 >>> 0;
      if (!noAssert) {
        checkOffset(offset, byteLength22, this.length);
    ...
    Buffer3.prototype.readIntLE = function readIntLE(offset, byteLength22, noAssert) {
      offset = offset >>> 0;
      byteLength22 = byteLength22 >>> 0;
      if (!noAssert)
        checkOffset(offset, byteLength22, this.length);
    ...
    Buffer3.prototype.readIntBE = function readIntBE(offset, byteLength22, noAssert) {
      offset = offset >>> 0;
      byteLength22 = byteLength22 >>> 0;
      if (!noAssert)
        checkOffset(offset, byteLength22, this.length);
    ...
    Buffer3.prototype.writeUintLE = Buffer3.prototype.writeUIntLE = function writeUIntLE(value, offset, byteLength22, noAssert) {
      value = +value;
      offset = offset >>> 0;
      byteLength22 = byteLength22 >>> 0;
      if (!noAssert) {
    ...
    Buffer3.prototype.writeUintBE = Buffer3.prototype.writeUIntBE = function writeUIntBE(value, offset, byteLength22, noAssert) {
      value = +value;
      offset = offset >>> 0;
      byteLength22 = byteLength22 >>> 0;
      if (!noAssert) {
    ...
    Buffer3.prototype.writeIntLE = function writeIntLE(value, offset, byteLength22, noAssert) {
      value = +value;
      offset = offset >>> 0;
      if (!noAssert) {
    ...
    Buffer3.prototype.writeIntBE = function writeIntBE(value, offset, byteLength22, noAssert) {
      value = +value;
      offset = offset >>> 0;
      if (!noAssert) {
        const limit = Math.pow(2, 8 * byteLength22 - 1);
    ...
    Buffer3.prototype.copy = function copy(target, targetStart, start, end) {
      if ((!Buffer3.isBuffer(target)) && !ArrayBuffer.isView(target)) {
