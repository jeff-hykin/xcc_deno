...
var require_buffer = __commonJS4({
  "../esmd/npm/buffer@6.0.3/node_modules/.pnpm/buffer@6.0.3/node_modules/buffer/index.js"(exports) {
    ...
    exports.SlowBuffer = SlowBuffer22;
      ...
      if (value > max || value < min) {
        ...
        if (byteLength22 > 3) {
          if (min === 0 || min === BigInt(0)) {
            range = `>= 0${n2} and < 2${n2} ** ${(byteLength22 + 1) * 8}${n2}`;
          } else {
            range = `>= -(2${n2} ** ${(byteLength22 + 1) * 8 - 1}${n2}) and < 2 ** ${(byteLength22 + 1) * 8 - 1}${n2}`;
          }
        } else {
